...
|---|---:|---|
| libil2cpp.so | 61184976 | `2286adf1320cd7710eb3f3e9d7d6b1822d6d5740b4a33879a630b79c6d64abc2` |
| global-metadata.dat | 9477776 | `1b0183c154c8a172fdd1cdc3ff41ea8c8136a48d79aeedbbf3b672e9d89aec63` |
| Il2CppDumper.exe | 13374349 | `071e36d396ae93cb2cfec032513b46a6bfd67e9b93157830711ab6d79db55045` |
| fresh dump.cs | 22616362 | `de37d35f9f44d50fce132f3f4513b37d302b182f3c3a11efea9590df916fa317` |
| fresh stringliteral.json | 1465637 | `7d77181c0a5e64666bee3caf7020898e3923f6f6ea878f621634a51321346e81` |
...
|---|---|
| `NCompound2.dat` | `0x3948710` |
| `NFormula.dat` | `0x3948720` |
| `NItem.Dat` | `0x3948740` |
| `NItem_EN.Dat` | `0x3948748` |
| `NNpc.dat` | `0x3948780` |
| `NNpc_EN.dat` | `0x3948790` |
| `NSceneData.dat` | `0x39487D8` |
| `NSceneData_EN.dat` | `0x39487E8` |
| `NSkill.dat` | `0x39487F0` |
| `NSkill_EN.dat` | `0x39487F8` |
| `NTalk.dat` | `0x3948818` |
| `NTalk_EN.dat` | `0x3948828` |
...
Namespace `Game.Data`; class; TypeDef `1173`.
...
- `private byte m_bCompleteDownload; // 0x21`
- `private Dictionary<E_UrlPathAreaType, string> mAreaDownloadPathMap; // 0x28`
- `private Dictionary<E_UrlPathAreaType, string> m_tLocalAreaDownloadMap; // 0x30`
...
Namespace `Game.Data`; struct; TypeDef `1170`.
...
Namespace `Game.Data`; struct; TypeDef `1171`.
...
Namespace `Game.Data`; class; TypeDef `1172`.
...
Namespace `Game.Data`; struct; TypeDef `1179`.
...
Namespace `Game.Data`; class; TypeDef `1180`.
...
Namespace `Game.Data`; struct; TypeDef `1181`.
...
Namespace `Game.Data`; struct; TypeDef `1182`.
...
Namespace `Game.Data`; struct; TypeDef `1183`.
...
Namespace `Game.Data`; struct; TypeDef `1184`.
...
Namespace `Game.Data`; struct; TypeDef `1185`.
...
Namespace `Game.Data`; class; TypeDef `1186`.
...
Namespace `Game.Data`; class; TypeDef `1188`.
...
Namespace `Game.Data`; struct; TypeDef `1196`.
...
Namespace `Game.Data`; class; TypeDef `1198`.
...
Namespace `Game.Data`; struct; TypeDef `1221`.
...
Namespace `Game.Data`; class; TypeDef `1223`.
...
Namespace `Game.Data`; struct; TypeDef `1228`.
...
Namespace `Game.Data`; class; TypeDef `1229`.
...
Namespace `Game.Data`; class; TypeDef `1230`.
...
Namespace `Game.Data`; struct; TypeDef `1236`.
...
Namespace `Game.Data`; class; TypeDef `1237`.
...
Namespace `Game.Data`; class; TypeDef `1238`.
...
Namespace `Game.Data`; struct; TypeDef `1239`.
...
Namespace `Game.Data`; class; TypeDef `1240`.
...
Namespace `Game.Data`; class; TypeDef `1241`.
...
Namespace `Game.Data`; class; TypeDef `1242`.
...
Namespace `Game.Data`; class; TypeDef `1249`.
